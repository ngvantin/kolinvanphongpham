...
import com.pro.electronic.utils.DateTimeUtils.convertDate2ToTimeStamp
import com.pro.electronic.utils.DateTimeUtils.convertTimeStampToDate2
import com.pro.electronic.utils.GlobalFunction.showDatePicker
...
class AdminRevenueActivity : BaseActivity() {
    ...
    private fun canAddOrder(order: Order?): Boolean {
        ...
        val strDateOrder = convertTimeStampToDate2(order.id)
